...
<section>
	<nav class="px-4 sm:px-10 py-4 bg-[#295936]">
		<div class="flex items-center justify-between">
						...
						<ul class="flex items-center">
							{#each FooterLinks.data as Link}
								{#if CheckCurrentURL(Link) === true}
									...
									<li class="font-heading mr-12 text-white hover:text-gray-200">
										<a href={Link}>{Link}</a>
									</li>
								{:else}
									<li class="font-heading mr-12 text-white hover:text-gray-200">
			...
			<div class="w-auto hidden lg:flex items-center">
				<a
					class="inline-block mr-12 font-heading font-medium text-base text-white hover:text-gray-200"
					href="#">Log in</a
				><a
	...
	<div class="hidden navbar-menu fixed top-0 left-0 bottom-0 w-5/6 max-w-sm z-50">
		<div
			class="navbar-backdrop fixed inset-0 backdrop-blur backdrop-filter bg-gray-900 bg-opacity-50"
		/>
